...
// struct Person
// {
//     int                        id = 0 JSONSER_SKIP(id);
//     int                        age;
//     std::string name           JSONSER_FIELD(name, "first_name");
//     Passport                   passport;
//     Gender                     gender;
//     std::optional<int>         foreignPassportId;
//     std::optional<std::string> warTicketId;
// };
...
//         .age = 20,
//         .name = "Igor",
//         .passport{.serial = 1234, .number = 123456},
//         .gender = Gender::Male,
//         .foreignPassportId = std::nullopt,
//         .warTicketId = "B"
//     };
//     nlohmann::json j;
//     jsonser::Serialize::toJson(j, p);
//     std::cout << j.dump() << '\n';

//     // try
//     // {

//     //     const std::string_view sv = R"({
//     //         "age": 20,
//     //         "first_name": "Igor",
//     //         "passport": {"serial": 1234, "number": 789632},
//     //         "gender": "Male",
//     //         "foreignPassportId": 214566978
//     //         })";
//     //     nlohmann::json         j = nlohmann::json::parse(sv);
//     //     std::cout << j.dump() << '\n';
//     //     Person p;

//     //     jsonser::Deserialize::fromJson(j, p);

//     //     nlohmann::json j2;
//     //     jsonser::Serialize::toJson(j2, p);
//     //     std::cout << j2.dump() << '\n';
//     // }
